...
public class PaintingDetails extends AppCompatActivity implements RelativePaintingsAdapter.ClickRelative
{
    ...
    private String Relative_URL = "/RelativeProducts.php?Username=";
    private String URL = "";
    ImageView i2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences sp2 = PreferenceManager.getDefaultSharedPreferences(PaintingDetails.this);
...
//        nb = findViewById(R.id.badge);
        ...
        paintOwner.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                editor.apply();
                startActivity(new Intent(PaintingDetails.this, ArtistBio.class));
                finish();
            }
        });
            ...
            public void onResponse(JSONArray response)
            {
                ...
                for (int i = 0; i < response.length(); i++)
                {
                    try
                    {
                        ...
                        paintingsImageViewPager = new PaintingsImageViewPager(PaintingDetails.this, imageurlLists);
    ...
    private void relativePaintingsJsonrequest()
    {
        JsonArrayRequest featuredRequest = new JsonArrayRequest(Relative_URL, new Response.Listener<JSONArray>()
        {
            @Override
            public void onResponse(JSONArray response)
            {
                ...
                for (int i=0; i < response.length(); i++)
                {
                    try
                    {
                        ...
                        Paintings relativepaintings = new Paintings(id, title, image, owner, price);
                        relativePaintings.add(relativepaintings);
            ...
            public void onErrorResponse(VolleyError error)
            {
                ...
                Toast.makeText(PaintingDetails.this, message, Toast.LENGTH_SHORT).show();
            }
        });

        MySingleton.getInstance(PaintingDetails.this).addToRequestQueue(featuredRequest);
    }
...
//            descriptionText.setText(paintings.getDescription());
    ...
    private void AddorRemoveFavorite(boolean b)
    {
        FavoriteDatabase favoriteDatabase = FavoriteDatabase.getInstance(getApplication());
...
//        });
    ...
    public boolean onCreateOptionsMenu(Menu menu)
    {
        ...
        cartview2.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                startActivity(new Intent(PaintingDetails.this, CartActivity.class));
            }
        });
        ...
        favview.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                startActivity(new Intent(PaintingDetails.this, FavouritePainting.class));
            }
        });
