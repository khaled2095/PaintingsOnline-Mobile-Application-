...
class FeaturedCollectionViewCell: UICollectionViewCell , UICollectionViewDelegate, UICollectionViewDataSource  {
    ...
    public func LoadFeatured() {
      ...
      //  ListofPaintings.removeAll()
        ...
        var URL1 = MainURL +  "/ShowPaintings.php?Search=&Type=Featured"
