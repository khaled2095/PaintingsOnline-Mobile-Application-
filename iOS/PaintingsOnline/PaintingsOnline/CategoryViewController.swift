...
class CategoryViewController: UIViewController , UITableViewDataSource, UITableViewDelegate{
        ...
        var ListOfTitle = ["Abstract","Landscape","Figurative","Floral","Cityscape","Seascape","Paris","Nature","Buddha","Animals & Birds","Nude","Music","Women"];
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.CImage.image = UIImage(named: ListOfTitle[indexPath.row] as String)
